...
def lambda_handler(event, context):
    ...
    userid = event.get("path", {}).get("user-id")
    if postid is not None and userid is not None:
        ...
        try:
            r = dynamo.update_item(
                ...
                UpdateExpression="DELETE likes :like SET like_count = like_count - :1",
...
# curl -H "Content-Type: application/json" -v -X POST https://calligre.com/api/content/1470003029.5935809612274169921875/likes/12
